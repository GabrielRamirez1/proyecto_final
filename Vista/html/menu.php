        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($roles == 1) { ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?accion=tareas">Tareas</a>
                    </li> 
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?accion=mistareas">Mis Tareas</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form ROLE="FORM" METHOD="POST" ACTION="index.php?accion=clienteactualizar">
                    ...
                    <center><button type="submit" class="btn btn-primary btn-sm">Actualizar&nbsp; &nbsp; <i class="fa-solid fa-floppy-disk"></i></button></center>
                </form>
            </div>
